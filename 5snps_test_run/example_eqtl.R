...
#SNP_file_name = "eqtl_snp_file" 
# zee_snps is a test run using 6 snps.
SNP_file_name = "zee_snps_for_eqtl"

# Gene expression file name
#expression_file_name = paste(base.dir, "/data/GE.txt", sep="");
#expression_file_name = "GE.txt"
expression_file_name = "../ge_for_eqtl.txt"

# Covariates file name
# Set to character() for no covariates
covariates_file_name = "../age_and_gender.txt"

# Output file name

output_file_name = 'eqtl_results';
